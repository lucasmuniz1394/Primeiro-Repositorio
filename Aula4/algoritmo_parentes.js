...
// Obs: A função INTERNA consegue ver as EXTERNAS, só que as EXTERNAS não conseguem ver as que são INTERNAS, se você tenta executar uma 
//função seguindo essa lógica vai conseguir já o contrário não, esse é o segredo do aninhamento.
